...
const testimonials = [
  {
    ...
    content: "The AI receptionist has been a game-changer. We went from missing 30% of calls to capturing every single lead. Our bookings increased dramatically in just 3 months.",
    rating: 5,
  ...
  },
  {
    name: "David Chen",
    role: "Auto Group CEO",
    content: "The ROI speaks for itself. We've seen a 400% increase in booked appointments. The AI handles calls so naturally, customers don't even realize it's not human.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Storm season used to mean missed calls and lost jobs. Now the AI books estimates 24/7, even at 2 AM during emergencies. Solid system, though I wish it integrated with our CRM better.",
    rating: 4,
  ...
  },
  {
    ...
    content: "During summer, we were drowning in service calls. The AI now handles scheduling and even upsells maintenance plans. Revenue up 35% this year.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Great for capturing leads when my crews are out in the field. The website they built showcases our work beautifully. Only minor hiccup was initial setup took longer than expected.",
    rating: 4,
  ...
  },
  {
    ...
    content: "The AI receptionist handles emergency calls perfectly—routes urgent AC repairs immediately while booking routine maintenance. Our customers love the instant response.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Finally, a solution that understands the roofing business. It asks the right questions about damage type and schedules inspections automatically. Worth every penny.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The new website increased our quote requests by 60%. The AI handles initial consultations and gathers project details before we even speak to the client.",
    rating: 4,
